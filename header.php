...
<a href= "<?php bloginfo('url')?>" ><img src="<?php bloginfo('template_directory'); ?>/img/logo.png" alt="logo" class="img-fluid float-start" style="width: 15vw; height: 5vw; margin-right: 3vw;"/> </a>
  <div class="container">
