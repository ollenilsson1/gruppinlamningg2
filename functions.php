...
function wpbootstrap_enqueue_styles()
{
    ...
    wp_enqueue_script('bootstrapjs',  'https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js', array(), 1, 1, 1);
    wp_enqueue_script('customscript', get_template_directory_uri() . '/js/main.js');
}
